...
class TestHero(TestCase):
    ...
    def test_battle_returns_drw_when_both_heroes_Die(self):
    ...
    def test_battle_returns_defeat_when_enemy_dies(self):
    ...
    def test_hero_Str_Returns_proper_message(self):
        ...
        expected = f"Hero {self.ATTACKER_USERNAME}: {self.HERO_LEVEL} lvl\n" \
